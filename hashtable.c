...
// Define the Hash Table Item here  struct Ht_item {
    char* key;
    char* value;
};
 CVFB F HBN 
...
int main() {
    ...
    ht_insert(ht,"num1", "REAL");
    ht_insert(ht, "num2", "INTEGER");
    ht_insert(ht, "num3", "INTEGER");
    ht_insert(ht, "num4", "REAL");
    printf("insertion done....\n");
    print_search(ht, "num1");
